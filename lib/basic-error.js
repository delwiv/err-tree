...
function setRendererGetterSetter(name) {
  Object.defineProperty(BasicError.prototype, name, {
    enumerable: true,
    get: function() {
      return this['$' + name];
    },
...
_.each(['ns', 'message', 'code', 'parsedStack'], setRendererGetterSetter);
